...
const nama_instansi = 'Rumah Sakit Pelamonia'; // Hospital Name
const apiUrl = 'https://mobile.rumkitpelamoni.id/api/'; // API Server URL
const website_upload = 'https://mobile.rumkitpelaonia.id/uploads/'; // Website Uploads Server URL
const webapps_url = 'http://mobile.rumkitpelaonia.id/webapps/'; // Webapps Server URL
...
var app  = new Framework7({
  ...
  id: 'id.rumkitpelamonia.register', // App bundle ID
  name: 'Pelamonia Mobile', // App name
  dialog: {
    title: 'Peringatan',
    buttonOk: 'Ya',
    buttonCancel: 'Tidak'
...
if (debug == '1') {
  ...
  function appReady(){
    ...
    document.addEventListener('resume', function(){
      ga('send', 'pageview' , {'location' : 'http://mobile.rumkitpelamonia.id/pasien-rest/index.html' });
    }, false);
    ...
    function onBackKeyDown() {
      ...
      app.dialog.close();
      if (page === 'landing') {
        app.dialog.confirm('Anda yakin ingin menutup aplikasi Pelamonia?', function () {
